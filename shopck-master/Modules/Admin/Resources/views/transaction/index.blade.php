            ...
            <tbody>
                @foreach($transactions as $transaction)
                    <tr>
                        ...
                        <td>
                            <a class="btn_customer_action  btn btn-danger" href="">Xóa <i class="fas fa-trash"></i></a>
                            <a class="btn_customer_action js_order_item btn btn-primary" data-id="{{ $transaction->id }}" href="{{ route('admin.get.view.order',$transaction->id)}}" >Xem <i class="fas fa-eye"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <div class="modal fade" id="myModalOrder" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" id="md_content"></div>
