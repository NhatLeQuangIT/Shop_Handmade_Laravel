    ...
    <div class="row">
        <div class="col-sm-8">
            ...
            <div class="form-group">
                ...
                <textarea name="pro_description" id="" class="form-control" cols="30" rows="3"
                          placeholder="Mô tả ngắn sản phẩm">{{ old('pro_description',isset($product->pro_description) ? $product->pro_description:'') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="pro_content" id="" class="form-control" cols="30" rows="3"
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group">
                ...
                <input type="number" placeholder="giảm giá" class="form-control" name="pro_number" value="{{ old('pro_number',isset($product->pro_number) ? $product->pro_number : '0')  }}">
            </div>
            <div class="form-group">
                <img id="out_img" src="{{ asset('images/default-image.jpg') }}" alt="" style="width: 100%; height: 300px">
            </div>
            ...
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="hot">Nổi bật</label>
                </div>
            </div>
        </div>
    </div>
