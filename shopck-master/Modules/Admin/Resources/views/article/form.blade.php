    ...
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="form-group">
                ...
                <textarea name="a_description" id="" class="form-control" cols="30" rows="3"
            ...
            <div class="form-group">
                ...
                <textarea name="a_content" id="" class="form-control" cols="30" rows="3"
            ...
            <div class="form-group">
                <img id="out_img" src="{{ asset('images/default-image.jpg') }}" alt="" style="width: 300px; height: 300px">
            </div>
