                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-3 col-xs-3">
                                        <img class="img-responsive" style="width: 100px;height: 80px;" src="{{asset(pare_url_file($product->options->avatar))}}" />
                                    </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                    <textarea name="note" cols="30" rows="8" class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
