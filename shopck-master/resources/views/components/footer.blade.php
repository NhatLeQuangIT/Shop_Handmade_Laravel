                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <p class="footer-des">Bạn đang muốn làm đồ handmade để bán nhưng chưa biết cách làm đồ handmade để bán như thế nào? Những đồ handmade bán chạy nhất năm 2019 là gì? Sản phẩm handmade nào bán chạy nhất? các mặt hàng handmade bán chạy là gì?. Hoàng loạt những câu hỏi những thắc mắc của bạn thì bài viết sau đây sẽ gợi ý cho bạn top 12 đồ handmade bán chạy nhất giúp bạn có thể lựa chọn loại đồ handmade phù hợp với mình để kinh doanh.</p>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Địa chỉ</h3>
                            <p>Hạ Lang - Xã Quảng Phú - huyện Quảng Điền - tỉnh Thừa Thiên Huế</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xs-12">
                    <address>Copyright © <a href="">NHATLAMHANDMADE</a> All Rights Reserved</address>
                </div>
                <div class="col-md-6 col-xs-12">
