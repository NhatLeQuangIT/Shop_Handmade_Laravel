...
<head>
    ...
    <![endif]-->
    <script src="https://kit.fontawesome.com/d7611317b8.js" crossorigin="anonymous"></script>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="{{ \Request::route()->getName() == 'user.list.product_care' ? 'active' : '' }}"><a href="{{ route('user.list.product_care')}}">Sản phẩm yêu thích</a></li>
